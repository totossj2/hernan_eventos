      ...
      <div className="container mx-auto px-4">
                ...
                >
                  <div className="p-1">
                    <Card className="border-0 shadow-lg h-full">
                      <CardContent className="p-6 h-[330px] md:h-[360px] flex flex-col">
                        ...
                        <p className=" text-base  text-gray-600 max-w-2xl mx-auto mb-4 flex-grow">
                          {testimonial.text}
                        </p>
        ...
        <div className="text-center mb-6 md:mb-16">
          <a
            ...
            target="_blank"
          >
            Mira el resto de reseñas desde nuestro perfil
