...
export const metadata: Metadata = {
  title:
    'Alquiler de Escenarios y Tarimas | Ferrario Structures — Estructuras para eventos',
  description:
  ...
  keywords: [
    ...
    'Estructuras para eventos escenarios',
  ],
  openGraph: {
    title:
      'Alquiler de Escenarios y Tarimas | Ferrario Structures — Estructuras para eventos',
  ...
  twitter: {
    ...
    title: 'Alquiler de Escenarios y Tarimas | Ferrario Structures — Estructuras para eventos',
